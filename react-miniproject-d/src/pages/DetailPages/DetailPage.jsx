...
<>
    <div>
                ...
                <div>
                    ...
                    <div className='Tombol'>
                        ...
                        <div className='watchlist-btn'>
                            <Button style={{}} variant="outline-secondary" size='lg'>Add to Watchlist</Button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <Container>
        <Row>
    <Col className='LinkBtn'>
    <a href='/'> <Badge pill bg="danger"> All </Badge></a>
                   <a href='/'> <Badge pill bg="danger"> Danger </Badge></a>
                   <a href='/DetailPage/Character/'>  <Badge pill bg="danger"> Character </Badge></a>
                   <a href='/DetailPage/Review/'> <Badge pill bg="danger"> Review </Badge></a>
</Col>
    <Col md="auto">
        
    </Col>
    <Col xs lg="2" className='submitBtn'>
    <a href='/'> <Badge pill bg="danger"> Submit </Badge></a>
            ...
            {/* <div className='BtnLink'>
                ...
                <a href='/'> <Badge pill bg="danger"> All </Badge></a>
                   <a href='/'> <Badge pill bg="danger"> Danger </Badge></a>
                   <a href='/'>  <Badge pill bg="danger"> Character </Badge></a>
                   <a href='/'> <Badge pill bg="danger"> Review </Badge></a>
